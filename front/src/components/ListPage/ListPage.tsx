        ...
        <div className="list_page_body">
            <header className="list-page-header">
                ...
                <div style={{display: "flex"}}>
                    ...
                    {props.titleButtonLabel && props.titleButtonCallback && <button style={{display: props.hideTitleButton ? "none":"flex"}} className="title-button" onClick={()=>{props.titleButtonCallback && props.titleButtonCallback()}}>
